# -*- coding: utf-8 -*-
"""
Created on Thu Sep 10 11:46:13 2020
...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep 10 11:44:29 2020
...
def loadfile():
    ...
    labels = []
    # 拿到图像数据路径，方便后续读取
    imagePaths = sorted(list(list_images('./dataset/set8')))
    random.seed(42)
...
#    # 绘制结果曲线
    ...
    plt.legend()
    plt.savefig('./output/InceptionResNetV2.png')
    #
    # 保存模型
    print("------正在保存模型------")
    model.save('./output/InceptionResNetV2.model')
    f = open('./output/InceptionResNetV2.pickle', "wb")
